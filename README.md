...
## Model
www.msaez.io/#/storming/stmallapexacme-22
...
- delivery
```
 http :8088/deliveries id="id" orderId="orderId" productName="productName" productId="productId" qty="qty" status="status" deliveryDt="deliveryDt" 
```
- product
```
