...
import stmallapexacme.domain.InventoryDecreased;
import stmallapexacme.domain.InventoryIncreased;
...
public class Inventory {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void increaseStock(DeliveryCollected deliveryCollected) {
        //implement business logic here:
